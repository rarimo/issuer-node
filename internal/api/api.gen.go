...
const (
	...
	DuneApiKeyScopes = "duneApiKey.Scopes"
)
...
// GetClaimStateStatusResponse defines model for GetClaimStateStatusResponse.
...
type ServerInterface interface {
	...
	// Count claims
	// (GET /v1/count_claims)
	GetClaimsCount(w http.ResponseWriter, r *http.Request, params GetClaimsCountParams)
	// Get Identities
	// (GET /v1/identities)
...
// Get Claim MTP
// (GET /v1/claims/{id}/mtp)
func (_ Unimplemented) GetClaimMTP(w http.ResponseWriter, r *http.Request, id PathClaim, params GetClaimMTPParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Count claims
// (GET /v1/count_claims)
func (_ Unimplemented) GetClaimsCount(w http.ResponseWriter, r *http.Request, params GetClaimsCountParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get Revocation Status
// (GET /v1/{identifier}/claims/revocation/status/{nonce})
func (_ Unimplemented) GetRevocationStatus(w http.ResponseWriter, r *http.Request, identifier PathIdentifier, nonce PathNonce, params GetRevocationStatusParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get Claim State Status
// (GET /v1/{identifier}/claims/{id}/status)
func (_ Unimplemented) GetClaimStateStatus(w http.ResponseWriter, r *http.Request, identifier PathIdentifier, id PathClaim) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetClaimsCount operation middleware
func (siw *ServerInterfaceWrapper) GetClaimsCount(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	ctx = context.WithValue(ctx, DuneApiKeyScopes, []string{})
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetClaimsCount(w, r, params)
	}))
...
// GetClaimStateStatus operation middleware
func (siw *ServerInterfaceWrapper) GetClaimStateStatus(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetClaimStateStatus(w, r, identifier, id)
	}))
...
func (siw *ServerInterfaceWrapper) SubscribeToClaimWebsocket(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SubscribeToClaimWebsocket(w, r, identifier, id)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/v1/count_claims", wrapper.GetClaimsCount)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/v1/{identifier}/claims/{id}/status", wrapper.GetClaimStateStatus)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/v1/{identifier}/claims/{id}/status/subscribe", wrapper.SubscribeToClaimWebsocket)
	})
	r.Group(func(r chi.Router) {
...
type GetClaimsCountRequestObject struct {
	Params GetClaimsCountParams
}

type GetClaimsCountResponseObject interface {
	VisitGetClaimsCountResponse(w http.ResponseWriter) error
}

type GetClaimsCount200JSONResponse GetClaimsCountResponse

func (response GetClaimsCount200JSONResponse) VisitGetClaimsCountResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetClaimsCount400JSONResponse struct{ N400JSONResponse }

func (response GetClaimsCount400JSONResponse) VisitGetClaimsCountResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type GetClaimsCount401JSONResponse struct{ N401JSONResponse }

func (response GetClaimsCount401JSONResponse) VisitGetClaimsCountResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(401)
...
type GetClaimsCount500JSONResponse struct{ N500JSONResponse }

func (response GetClaimsCount500JSONResponse) VisitGetClaimsCountResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type GetClaimStateStatusRequestObject struct {
	Identifier PathIdentifier `json:"identifier"`
	Id         PathClaim      `json:"id"`
}

type GetClaimStateStatusResponseObject interface {
	VisitGetClaimStateStatusResponse(w http.ResponseWriter) error
}

type GetClaimStateStatus200JSONResponse GetClaimStateStatusResponse

func (response GetClaimStateStatus200JSONResponse) VisitGetClaimStateStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetClaimStateStatus400JSONResponse struct{ N400JSONResponse }

func (response GetClaimStateStatus400JSONResponse) VisitGetClaimStateStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type GetClaimStateStatus404JSONResponse struct{ N404JSONResponse }

func (response GetClaimStateStatus404JSONResponse) VisitGetClaimStateStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type GetClaimStateStatus500JSONResponse struct{ N500JSONResponse }

func (response GetClaimStateStatus500JSONResponse) VisitGetClaimStateStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// Count claims
	// (GET /v1/count_claims)
	GetClaimsCount(ctx context.Context, request GetClaimsCountRequestObject) (GetClaimsCountResponseObject, error)
	// Get Identities
	// (GET /v1/identities)
...
// GetClaimsCount operation middleware
func (sh *strictHandler) GetClaimsCount(w http.ResponseWriter, r *http.Request, params GetClaimsCountParams) {
	var request GetClaimsCountRequestObject

	request.Params = params

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetClaimsCount(ctx, request.(GetClaimsCountRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetClaimsCount")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetClaimsCountResponseObject); ok {
		if err := validResponse.VisitGetClaimsCountResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// GetClaimStateStatus operation middleware
func (sh *strictHandler) GetClaimStateStatus(w http.ResponseWriter, r *http.Request, identifier PathIdentifier, id PathClaim) {
	var request GetClaimStateStatusRequestObject

	request.Identifier = identifier
	request.Id = id

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetClaimStateStatus(ctx, request.(GetClaimStateStatusRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetClaimStateStatus")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetClaimStateStatusResponseObject); ok {
		if err := validResponse.VisitGetClaimStateStatusResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// SubscribeToClaimWebsocket operation middleware
func (sh *strictHandler) SubscribeToClaimWebsocket(w http.ResponseWriter, r *http.Request, identifier PathIdentifier, id PathClaim) {
