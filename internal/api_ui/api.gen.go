...
type ServerInterface interface {
	...
	GetRevocationStatus(w http.ResponseWriter, r *http.Request, nonce PathNonce, params GetRevocationStatusParams)
	// Revoke Credential
...
// Get Claim MTP
// (GET /v1/claims/{id}/mtp)
func (_ Unimplemented) GetClaimMTP(w http.ResponseWriter, r *http.Request, id Id, params GetClaimMTPParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Get Revocation Status
// (GET /v1/credentials/revocation/status/{nonce})
func (_ Unimplemented) GetRevocationStatus(w http.ResponseWriter, r *http.Request, nonce PathNonce, params GetRevocationStatusParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Claim Offer
// (GET /v1/credentials/{user-id}/{claim-type})
func (_ Unimplemented) ClaimOffer(w http.ResponseWriter, r *http.Request, userId PathIdentifier, claimType PathClaimType) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) GetRevocationStatus(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetRevocationStatus(w, r, nonce, params)
	}))
...
// GetClaimMTP operation middleware
func (sh *strictHandler) GetClaimMTP(w http.ResponseWriter, r *http.Request, id Id, params GetClaimMTPParams) {
...
// GetRevocationStatus operation middleware
func (sh *strictHandler) GetRevocationStatus(w http.ResponseWriter, r *http.Request, nonce PathNonce, params GetRevocationStatusParams) {
